...
def lambda_handler(event, context):
    ...
    for export in exports:
        try:
            query_employees = 'select api_employee.emp_id,api_employee.name,api_employee.permanent_address_line1,api_employee.designation,api_employee.gender,api_employee.official_email,api_employee.date_of_joining,api_employee.department,api_employee.official_number,api_employee.dob,api_employee.work_location_add from api_employee'
