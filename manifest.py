...
def lambda_handler(event, context):
    ...
    # Status check
    status_export_file_query = "Select * from api_export where file_type='Manifest' and status='Generating'"
    ...
    export_file_query = "Select * from api_export where file_type='Manifest' and exfile_iscreated = FALSE LIMIT 1"
    ...
    for export in exports:
        try:
            ...
            file_name = 'exports-manifest'+'.csv'
