...
def lambda_handler(event, context):
    ...
    print("body===")
    print(body)
    status_of_case = body["status_of_case"]
    print(status_of_case)
    status_of_case1 = "'" + status_of_case + "'"
    print(status_of_case1)
    ...
    # Status check
    status_export_file_query = "Select * from api_export where file_type='Reimburesement' and status='Generating'"
    ...
    export_file_query = "Select * from api_export where file_type='Reimburesement' and exfile_iscreated = FALSE LIMIT 1"
    ...
    for export in exports:
        try:
            ...
            if (status_of_case1):
                ...
                que = "where status_of_case =" + str(status_of_case1)
            ...
            file_name = 'exports-reimbursement'+'.csv'
            file_from = '/tmp/' + file_name
            with open(file_from, 'w', newline='') as file:
                writer = csv.writer(file)
                writer.writerows(data)
            file_to = '/buymore2/orders/manifest/' + file_name
